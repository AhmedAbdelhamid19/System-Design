...
- Many machines working together as if they are a single system.
- Multiple computers (servers) connected over a network, cooperating to behave like one powerful system.
...
This file is an overview. See the following files for deeper topics and tradeoffs.
